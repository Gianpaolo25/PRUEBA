...
public interface IGestorPersonas {
     ...
     * @return cadena con el resultado de la operación (ERROR_PROFESORES | PROFESORES_DUPLICADOS | ESCRITURA_PROFESORES_ERROR | EXITO_PROFESORES)
    */                                                                    
     ...
     * @return cadena con el resultado de la operación (ERROR_ALUMNOS | ALUMNOS_DUPLICADOS | ESCRITURA_ALUMNOS_ERROR | EXITO_ALUMNOS)
    */                                                                    
